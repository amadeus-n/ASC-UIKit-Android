...
object EkoDefaultPostViewHolders {
    ...
    internal const val noData = "noData"
    ...
    internal val noDataViewHolder = object : EkoIPostViewHolder {

        override fun getDataType(): String = noData

        override fun getLayoutId(): Int = R.layout.amity_item_no_data_post

        override fun createViewHolder(view: View, timelineType: EkoTimelineType): EkoBasePostViewHolder {
            return PostItemNoDataViewHolder(view, timelineType)
        }
